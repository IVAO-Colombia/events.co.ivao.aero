                ...
                <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded-md shadow-sm">
                    ...
                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                        ...
                        <span aria-current="page">
                            <span
                                class="relative inline-flex bg-amber-400 text-white hover:text-white items-center px-4 py-2 -ml-px text-sm font-medium border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600">{{
                                $page }}</span>
                        </span>
                        @else
                        <button type="button" wire:click="gotoPage({{ $page }}, '{{ $paginator->getPageName() }}')"
                            x-on:click="{{ $scrollIntoViewJsSnippet }}"
                            class="relative inline-flex items-center px-4 py-2 hover:bg-yellow-300 hover:text-white -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring ring-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400 dark:active:bg-gray-700 dark:focus:border-blue-800"
