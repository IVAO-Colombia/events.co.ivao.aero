<div class="">
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <p class="text-base leading-relaxed text-gray-500">
                        {{__('Before the event, we will hold a briefing on our Discord and/or social media channels.')}}
                    </p>

                    <p>
                        Discord: <a href="https://discord.co.ivao.aero" target="_blank"
                            class="text-[#0D2C99]">discord.co.ivao.aero</a>
                    </p>
                </div>
                <!-- Modal footer -->
    ...
    <div class="table-container m-5">
        @include('website.rfe24.widgets.booking.atc_list')
