<div class="flex flex-col gap-5 justify-center ">
    <section class="">
        <div x-data="{
            ...
            slides: [
                {
                    imgSrc: '{{asset('assets/img/banner_rfo.png')}}',
                    imgAlt: 'Banner rfo',
                    {{-- title: 'The second airport most visited in Colombia',
                    description: 'The architects of the digital world, constantly battling against their mortal enemy – browser compatibility.', --}}
                },
                {
                    imgSrc: '{{asset('assets/img/banner_2.jpg')}}',
                    imgAlt: 'Airplane in rionegro',
                }
            ],
            currentSlideIndex: 1,
            isPaused: false,
    ...
    <section class="w-full mt-16 relative" id="eventDetails">
        <div
            ...
            font-bold text-gray-900"><span
                        ...
                        Rionegro</span> {{__('the most awaited event of the year')}}
                </h1>
    ...
    <section
        class="flex flex-col justify-center items-center h-[50svh] bg-gradient-to-bl from-[#0D2C99] to-[#3C55AC] text-white">
    ...
    <section class="mb-5 px-12">
        <div class="grid grid-cols-2 gap-5">
            ...
            <article
                ...
                <!-- image -->
                <div class="col-span-3 overflow-hidden">
                    <img src="{{asset('assets/img/SKRG_TWR.jpg')}}"
                        class="h-52 md:h-full w-full object-cover transition duration-700 ease-out group-hover:scale-105"
                        alt="a men wearing VR goggles" />
                </div>
                <!-- body -->
    ...
    <script>
        ...
        var countDownDate = new Date("3 August 2024").getTime();
